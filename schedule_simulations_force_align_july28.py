"""
Script for running multiple simulation jobs concurrently.
"""
...
default_run_desc = OrderedDict({ # This will be changed for each different run
    'J': 0.1, 
    'D_r': 0.1, 
...
if __name__ == '__main__':
    ...
    for Jv_val in Jv_vals:
        for D_r_val in D_r_vals:
            ...
            # This code runs simulations concurrently on different threads
